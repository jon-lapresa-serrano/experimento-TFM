  ...
  plugin.info = {
    ...
    parameters: {
      ...
      message: {
        ...
        pretty_name: 'Message',
        default: '<p>Aviso: el experimento se abrirá en pantalla completa cuando pulse el botón de abajo.</p>' + '<p>Al pulsarlo usted también da su consentimiento para que podamos guardar los datos que nos proporcione a lo largo del experimento.</p>' + '<p>Le recordamos que ninguno de estos datos es personal y que todos serán guardados de forma completamente anónima.</p>' + '<p>También le invitamos a que interrumpa o posponga la realización del experimento en cualquier momento en caso de no sentirse a gusto.</p>',
        array: false,
